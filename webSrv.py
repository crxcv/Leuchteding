    ...
    <div class="row w-100">
      <div class="col-md-6">
        ...
        <form method="POST" action="/alarm" id="setTime">
          ...
          <button class="btn btn-primary" type="reset">Eingabe zur&uuml;cksetzen</button>
      ...
      <div class="col-md-6">
        <form method="POST" action="/alarm" id="setSound">
          ...
          <button class="btn btn-primary" type="submit" name="setSongButton" value="setSong">Song abspielen</button>
